...
class Empty extends TweetSet :
  ...
  def incl(tweet: Tweet): TweetSet = NonEmpty(tweet, this, this)
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet :
  ...
  def mostRetweeted: Tweet =
    ...
    else if !left.isEmpty && right.isEmpty then max(elem, left.mostRetweeted)
    else if left.isEmpty && !right.isEmpty then max(elem, right.mostRetweeted)
    else
  ...
  def descendingByRetweet: TweetList =
    ...
    Cons(tw, this.remove(tw).descendingByRetweet)
